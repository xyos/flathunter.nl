...
def extract_id_from_url(url):
    ...
    return int(id, base=16) if id else None


class Pararius(Crawler):
    """Implementation of Crawler interface for Pararius"""

    URL_PATTERN = re.compile(r"https://www\.pararius\.com")
    ...
    def extract_data(self, soup):
        """Extracts all listings from a provided Soup object for Pararius.com"""
        entries = []
